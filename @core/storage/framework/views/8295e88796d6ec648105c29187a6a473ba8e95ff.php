...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.donation.category','data' => ['id' => $data->id,'image' => $data->image,'title' => $data->title,'count' => $data->donation->count(),'description' => $data->description,'reward' => $data->reward]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\Dmitro\@core\resources\views/frontend/home-pages/home-01.blade.php ENDPATH**/ ?>